...
const Home = () => {
  return (
    <div className="Home">
      ...
      <p>Our mission is to provide a comprehensive platform for analyzing traffic incidents, understanding their impact on urban mobility, and ultimately contributing to safer and more efficient roadways.</p>
      <p>Traffic accidents are a critical issue in urban environments, often leading to congestion, injuries, and fatalities. With increasing advancements in real-time data collection, the ability to visualize and analyze accident patterns can significantly enhance traffic management strategies and commuter safety.</p>
